            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/helpers.CommonResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/helpers.CommonErrorResponse"
                        }
                    }
                }
            }
        ...
        "/authors/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Author Update Input",
                        "name": "author",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "created_at",
                        "description": "Sort field (e.g. title, year, created_at)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/publishers/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Publisher Update Input",
                        "name": "publisher",
                        "in": "body",
                        "required": true,
                        "schema": {
